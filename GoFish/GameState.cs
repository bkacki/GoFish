...
namespace GoFish
{
    public class GameState
    {
        ...
        public Player RandomPlayer(Player currentPlayer) =>
            Players.Where(player => player != currentPlayer).Skip(Player.Random.Next(Players.Count() - 1)).First();
        /// <summary>
        ...
        {
            var valuePlural = (valueToAskFor == Values.Szóstka) ? "Sixes" : $"{valueToAskFor}s";
